      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <div className="flex gap-4 items-center flex-col sm:flex-row flex-wrap">
            ...
            <Link
              className="rounded-full border border-solid border-green-600 bg-green-600 text-white transition-colors flex items-center justify-center hover:bg-green-700 font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto"
              href="/dnd-demo/multi-container"
            >
              カンバンボード
            </Link>
            <Link
              className="rounded-full border border-solid border-purple-600 bg-purple-600 text-white transition-colors flex items-center justify-center hover:bg-purple-700 font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto"
              href="/api-demo"
            >
              JSON Server API
            </Link>
